module deadcode.core.command;

public import deadcode.core.commandparameter;
...
*/
	...
	ICommand[] lookupFuzzyOld(string searchString)
	{
		ICommand[] result;
	...
	ICommand[] lookupFuzzy(string searchString, bool includeEmptySearch = false)
    {
        import std.algorithm;
        import std.array;
